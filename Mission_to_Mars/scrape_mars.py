...
def scrape():
    ...
    data['feature_img_url'] = feature_img_url
    ...
    data['fact_html_table'] = fact_html_table
    ...
    data['cerberus_title'] = cerberus_title
    data['cerberus_url'] = cerberus_url
    ...
    data['schiaparelli_title'] = schiaparelli_title
    data['schiaparelli_url'] = schiaparelli_url
    ...
    data['syrtis_major_title'] = syrtis_major_title
    data['syrtis_major_url'] = syrtis_major_url
    ...
    data['valles_marineris_title'] = valles_marineris_title
    data['valles_marineris_url'] = valles_marineris_url
